            ...
            <div class="form-row">
                <div class="col-12 mb-3 required">
                    <label for="register_name_input"><?php _e('Name' , 'radshid_lan'); ?></label>
                        <input type="text" class="form-control " id="register_name_input" name="txtName" required>
                        <div class="invalid-feedback">
            ...
            <div class="form-row">
                <div class="col-12 mb-3 required">
                    <label for="register_family_input"><?php _e('Family' , 'radshid_lan'); ?></label>
                        <input type="text" class="form-control " id="register_family_input" name="txtLastName" required>
                        <div class="invalid-feedback">
            ...
            <div class="form-row">
                <div class="col-12 mb-3 required">
                    <label for="register_username_input"><?php _e('Username' , 'radshid_lan'); ?></label>
                        <input type="text" class="form-control " id="register_username_input" name="txtRUsername" required>
                        <div class="invalid-feedback">
                            <span><?php _e('Please enter your username' , 'radshid_lan'); ?></span>
                        </div>
            ...
            <div class="form-row">
                <div class="col-12 mb-3 required">
                    <label for="register_password_input"><?php _e('Password' , 'radshid_lan'); ?></label>
                        <input type="password" class="form-control " id="register_password_input" name="txtRPass1" required>
                        <div class="invalid-feedback">
            ...
            <div class="form-row">
                <div class="col-12 mb-3 required">
                    <label for="register_password_confirm_input"><?php _e('Password Confirm' , 'radshid_lan'); ?></label>
                        <input type="password" class="form-control " id="register_password_confirm_input" name="txtRPass2" required>
                        <div class="invalid-feedback">
            ...
            <div class="form-row">
                <div class="col-12 mb-3 required">
                    <label for="register_mobile_input"><?php _e('Mobile Number' , 'radshid_lan'); ?></label>
                        <input type="text" class="form-control " id="register_mobile_input" name="txtMobile" required maxlength="10"
